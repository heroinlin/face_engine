...
from modules.object_detection import (OnnxObjectDetector as ObjectDetector, draw_detection_rects)
from modules.face_recognition import PyFeatureExtract as FeatureExtract
    ...
    def person_library_feature_extract(self):
        ...
        for person_folder in self.person_id_library:
            ...
            for image_path in images_list:
                ...
                face = self.crop_image(image.copy(), bounding_boxes[0], method=1)
                features_array = self.extractor.feature_extract(face)
